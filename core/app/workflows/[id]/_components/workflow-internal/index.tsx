...
import { useWorkflow as useWorkflowCrud } from '@/app/workflows/[id]/_components/workflow-main/hooks';
...
import WorkflowNameEditor from '../header/WorkflowNameEditor';
...
const WorkflowInternal: FC<WorkflowProps> = memo(
  ({ workflowId, initialData }) => {
    ...
    // Determine if nodes should be read-only based on workflow mode
